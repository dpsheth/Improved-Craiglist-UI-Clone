...
public void start(Stage primaryStage) {
  ...
  ImageView craigslistimage = new ImageView();
  craigslistimage.setImage(new Image("file:./res/craigslist.png"));
  craigslistimage.setFitHeight(35);
  craigslistimage.setFitWidth(170);
  ...
  Menu craigslist = new Menu("", craigslistimage);
  ...
  borderpane.getStylesheets().add("final.css");
  ...
  helpscene.getStylesheets().add("final.css");
  ...
  logInPane.getStylesheets().add("final.css");
  ...
  createAccountPane.getStylesheets().add("final.css");
  ...
  HBox categorybox = new HBox(40, categorylabel, categories);
  HBox postingcategorybox = new HBox(40, postingbox, categorybox);
  ...
  HBox postCancel = new HBox(25, post, cancel2);
  postCancel.setAlignment(Pos.CENTER);

  Label thankyou = new Label();

  VBox postings = new VBox(15, postingcategorybox, descriptionbox, citiesbox, pricebox);
  postings.setPadding(new Insets(0, 0, 0, 375));
  VBox postingpage = new VBox(40, createposting, postings, postCancel, thankyou);
  postingpage.setAlignment(Pos.CENTER);
  BorderPane borderpaneposting = new BorderPane(postingpage);
  borderpaneposting.getStylesheets().add("post.css");

  posting.setOnAction(event -> {
    scene.setRoot(borderpaneposting);
    borderpaneposting.setTop(menubar);
  });

  posting2.setOnAction(event -> {
    scene.setRoot(borderpaneposting);
    borderpaneposting.setTop(menubar);
  });
  ...
  post.setOnAction(event -> {
    thankyou.setText("Thank you! You're post was successful!");
  });
  ...
  borderpanecommunity.getStylesheets().add("post.css");
  ...
  Button goBackToCommunity = new Button("Go Back");
    ...
    communityButton.setOnAction(event -> {
      ...
      borderpaneCommunityTopic.getStylesheets().add("final.css");
  ...
  borderpanejob.getStylesheets().add("post.css");
  ...
  jobButton.setOnAction(event -> {
      ...
      jobCommunityTopic.getStylesheets().add("final.css");
  ...
  borderpanegigs.getStylesheets().add("post.css");
  ...
  gigsButton.setOnAction(event -> {
      ...
      gigsCommunityTopic.getStylesheets().add("final.css");
  ...
  borderpaneservices.getStylesheets().add("post.css");
  ...
  // View Resume Scene
    ...
    viewResumeBorderPane.getStylesheets().add("discuss.css");
  ...
  //For Sale page
       ...
       //For sale page 1
        ...
        ImageView cl2 = new ImageView(craigslistLogo);
        ...
        ImageView icon1 = new ImageView(craigslistIcon);
  ...
  //Housing page
          ...
          ImageView cl3 = new ImageView(craigslistLogo);
